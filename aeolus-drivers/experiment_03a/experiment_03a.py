"""
Experiment #03a: Adding restrictions to the time difference and distance.
...
As in experiment #02, expect a "results.csv" as output.
"""
...
CONF = SparkConf().setAppName('Experiment #03a')
